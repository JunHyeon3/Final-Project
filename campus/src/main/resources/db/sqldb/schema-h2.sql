...
CREATE CACHED TABLE "PUBLIC"."CAMPSITE"(
    ...
    "CAMPSITE_ENVIRONMENT" CHARACTER VARYING(255),

    "CAMPSITE_FACILITIE" CHARACTER VARYING(255),

    "CAMPSITE_THEME" CHARACTER VARYING(255),
...
CREATE CACHED TABLE "PUBLIC"."REVIEW"(
    ...
    "REVIEW_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 3) NOT NULL,
